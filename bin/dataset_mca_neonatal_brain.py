...
NAMESPACE = 'mca_neonatal_brain'
DIMRED = 100
DR_METHOD = 'svd'

data_names = [
    'data/murine_atlases/mca/NeonatalBrain1',
    'data/murine_atlases/mca/NeonatalBrain2',
]
...
def keep_valid(datasets):
    ...
    print('Found {} valid cells among all datasets'.format(len(valid_idx)))
...
dataset.obs['cell_types'] = [ 'mca_han_etal_neonatal_' + l for l in cell_types ]
